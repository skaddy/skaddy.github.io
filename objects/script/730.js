...
var stopper3 = T([0,1,2])([59,-18.1,48.7])(R([0,2])(-PI/2)(stopper(4, [0,0,0], [0,0,0,1], PI/3)));
var stopper4 = T([0,1,2])([55,-18.1,-6.7])(R([0,2])(PI/2)(stopper(4, [0,0,0], [0,0,0,1], PI/3)));
...
var stick21 = R([0,2])(PI/32)(T([0,1,2])([3,-18.55,0.6])(completeStick3));
var stick22 = R([0,2])(PI/48)(T([0,1,2])([3,-15.55,0.6])(completeStick3));
var stick23 = R([0,2])(PI/165)(T([0,1,2])([3,-12.55,0.6])(completeStick3));

var stick24 = R([0,2])(-PI/32)(T([0,1,2])([6.5,-18.55,42])(completeStick3));
var stick25 = R([0,2])(-PI/48)(T([0,1,2])([5,-15.55,42])(completeStick3));
var stick26 = R([0,2])(-PI/165)(T([0,1,2])([3,-12.55,42])(completeStick3));

var sideSticks = STRUCT([stick21, stick22,stick23,stick24,stick25,stick26]);
